...
| A-018 | `EARLIER_TECHNICAL_CLOSEOUT_BASELINE_MINUTES=212`; approved documentation estimate **+20** (not directly measured); reconciliation **+1** (measured, rounded up); **`FINAL_ACTIVE_MINUTES=233` (03:53)**; remaining **67** minutes under the five-hour hard limit | Honest stop under the five-hour hard limit | Remaining buffer shrinks if baseline was understated | DOCUMENTED |
